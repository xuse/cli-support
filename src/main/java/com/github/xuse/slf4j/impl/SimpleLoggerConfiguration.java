package com.github.xuse.slf4j.impl;
...
import com.github.xuse.slf4j.impl.OutputChoice.OutputChoiceType;
...
public class SimpleLoggerConfiguration {
	...
	String infoLevelString = "INFO";
	String errorLevelString = "ERROR";
	String debugLevelString = "DEBUG";
	...
	void init() {
		...
		infoLevelString = getStringProperty(SimpleLogger.INFO_LEVEL_STRING_KEY, infoLevelString);
		errorLevelString = getStringProperty(SimpleLogger.ERROR_LEVEL_STRING_KEY, errorLevelString);
		debugLevelString = getStringProperty(SimpleLogger.DEBUG_LEVEL_STRING_KEY, debugLevelString);
